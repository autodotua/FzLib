...
namespace FzLib.Geography
{
    public struct Angle : IEquatable<Angle>
    {
        ...
        public static Angle FromLatitude(Point point)
        {
            return FromDegree(point.Y);
        }
        public static Angle FromLongitude(Point point)
        {
            return FromDegree(point.X);
        }
        ...
        {
            return Angle.FromDegree(degrees);
        }
