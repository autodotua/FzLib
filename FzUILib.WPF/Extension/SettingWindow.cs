...
namespace FzLib.UI.Extension
{
    public class SettingWindow<T> : Window
    {
        ...
        private void InitializeLayout()
        {
            ...
            FzLib.UI.FlatStyle.Button btnOK = new FzLib.UI.FlatStyle.Button() { Content = "确定", Padding = new Thickness(12, 2, 12, 2), Margin = new Thickness(4) };
            FzLib.UI.FlatStyle.Button btnApply = new FzLib.UI.FlatStyle.Button() { Content = "应用", Padding = new Thickness(12, 2, 12, 2), Margin = new Thickness(4) };
            FzLib.UI.FlatStyle.Button btnCancel = new FzLib.UI.FlatStyle.Button() { Content = "取消", Padding = new Thickness(12, 2, 12, 2), Margin = new Thickness(4) };
            ...
            foreach (var prop in properties)
            {
                ...
                if (value is string || value is int || value is double || value is SolidColorBrush || value is Color)
                {
                    ...
                    if (value is string)
                    {
                        ...
                        valueControl = new FzLib.UI.FlatStyle.TextBox() { Text = value as string };
                    }
                    ...
                    {
                        tbk = new TextBlock() { Text = name };
                        valueControl = new FzLib.UI.Picker.ColorPickerTextBox() { ColorBrush = value as SolidColorBrush };

                    }
                    else if (value is Color)
                    {
                        tbk = new TextBlock() { Text = name };
                        valueControl = new FzLib.UI.Picker.ColorPickerTextBox() { ColorBrush = new SolidColorBrush((Color)value) };
                ...
                {
                    valueControl = new FzLib.UI.FlatStyle.CheckBox() { Content = name, IsChecked = (bool)value };
