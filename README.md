...
FzLib是一套本人开发过程中逐渐形成的工具库，包含数据、IO、加密解密、应用、界面等各方面的重复性代码。分为FzLib、FzLib.Avalonia和FzLib.Samples三个项目，分别包含界面无关的代码、Avalonia相关代码和前两者的示例。
...
| `Dialogs.Services` | 对话框服务     |[doc_FzLib.md](doc_FzLib.md)
