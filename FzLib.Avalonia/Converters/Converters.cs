...
namespace FzLib.Avalonia.Converters
{
    public static class Converters
    {
        ...
        public static readonly BoolLogicConverter AndLogic = new() { Operator = BoolLogicConverter.LogicalOperator.And };
        ...
        public static readonly CountToBoolConverter CountGreaterThanZero = new() { ComparisonValue = 0, Operator = ComparisonOperator.GreaterThan };
        public static readonly CountToBoolConverter CountIsZero = new() { ComparisonValue = 0, Operator = ComparisonOperator.Equal };
        ...
        public static readonly BoolToTextDecorationConverter OverlineTextDecoration = new() { TrueTextDecoration = TextDecorations.Overline };
